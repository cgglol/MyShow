...
import com.cgg.administrator.myshow.photoview.PhotoViewAttacher;
...
public class ImageDetailFragment extends Fragment {
	...
	private DisplayImageOptions imgO = new DisplayImageOptions.Builder()
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		ImageLoader.getInstance().displayImage(mImageUrl, mImageView, imgO,new SimpleImageLoadingListener() {
			@Override
