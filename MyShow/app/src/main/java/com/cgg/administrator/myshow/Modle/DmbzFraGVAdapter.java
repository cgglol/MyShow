...
public class DmbzFraGVAdapter extends BaseAdapter {

    private Context context;
    private List<DmbzFraBack.ShowapiResBodyBean.PagebeanBean.ContentlistBean> list;
    private ViewHolder viewHolder;

    public DmbzFraGVAdapter(Context context, List<DmbzFraBack.ShowapiResBodyBean.PagebeanBean.ContentlistBean> list) {
        this.context = context;
        this.list = list;
    }

    public void Updata(List<DmbzFraBack.ShowapiResBodyBean.PagebeanBean.ContentlistBean> list) {
        this.list = list;
